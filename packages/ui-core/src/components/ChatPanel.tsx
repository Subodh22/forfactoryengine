      ...
      <div className="bg-paper border-2 border-[#332f28] brutal-shadow">
        ...
        <div className="flex justify-between items-center px-6 py-4 mt-2">
          <div className="flex items-center gap-4">
            ...
            <button className="font-data text-[11px] uppercase flex items-center gap-1.5 text-ink/60 hover:text-ink transition-colors" onClick={captureScreen}>
              <Monitor className="w-4 h-4" />Screenshot
            </button>
