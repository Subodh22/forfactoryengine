        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            {job.pushState === "needs_help" && (
              <button
                className="flex items-center gap-1 px-2 py-0.5 font-data text-[10px] uppercase bg-[#d6210f] text-paper border-2 border-[#d6210f] hover:bg-paper hover:text-[#d6210f] transition-colors"
